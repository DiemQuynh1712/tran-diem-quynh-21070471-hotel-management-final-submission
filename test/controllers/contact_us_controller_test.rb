...
class ContactUsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create contact_u" do
    assert_difference("ContactU.count") do
      post contact_us_url, params: { contact_u: { information: @contact_u.information, via: @contact_u.via } }
    end
  ...
  test "should update contact_u" do
    patch contact_u_url(@contact_u), params: { contact_u: { information: @contact_u.information, via: @contact_u.via } }
